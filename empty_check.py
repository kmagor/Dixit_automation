...
#img = cv2.imread("igazi_fekete_pottyokkel.jpg", cv2.IMREAD_GRAYSCALE)
img = cv2.imread("sablon_pottyok_black.jpg", cv2.IMREAD_GRAYSCALE)

_, threshold = cv2.threshold(img, 240, 255, cv2.THRESH_BINARY)
#filterint out the tiny noises
threshold2=threshold
cv2.medianBlur(threshold,3, threshold2)
cv2.imshow("filtered", threshold2)
